...
public partial class Administration_AddParent : System.Web.UI.Page
{
    ...
    protected void AddNewParent_ActiveStepChanged(object sender, EventArgs e)
    {
        ...
        newUser.ChangePassword(AddNewParent.Password, "admin123");
        ...
        if (AddNewParent.ActiveStep.Title == "Complete")
        {
            ...
            DropDownList Gender = AddNewParent.CreateUserStep.ContentTemplateContainer.FindControl("Gender") as DropDownList;
            ...
            string insertSql = "INSERT INTO ParentProfiles(ParentId, FirstName, LastName, Contact, Address, Gender) VALUES(@UserId, @FirstName, @LastName, @Contact, @Address, @Gender)";
