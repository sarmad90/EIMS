      ...
      <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item active">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/img/Blackboard-Teachers-Students-Knowledge.jpg" Height="500px" Width="1200px" />
            <div class="carousel-caption">
              ...
            </div>
          </div>
          <div class="item">
            <asp:Image ID="Image2" runat="server" ImageUrl="~/img/college-professor.jpg" Height="500px" Width="1200px" />
            <div class="carousel-caption">
              ...
            </div>
          </div>
